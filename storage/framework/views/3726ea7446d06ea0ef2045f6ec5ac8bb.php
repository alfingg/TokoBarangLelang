    ...
    <div class="bg-white overflow-hidden shadow-lg rounded-xl transition duration-300 hover:shadow-2xl hover:scale-[1.02] border-t-4 border-indigo-500">
        <div class="p-5 flex items-center justify-between">
            <div>
                ...
                <div class="mt-1 text-3xl font-semibold text-gray-900"><?php echo e(number_format($totalProducts)); ?></div>
            </div>
        ...
        <div class="px-5 py-3 bg-gray-50 text-sm">
            <a href="<?php echo e(route('admin.products.index')); ?>" class="text-indigo-600 hover:text-indigo-900 font-medium">Lihat Semua Produk &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-lg rounded-xl transition duration-300 hover:shadow-2xl hover:scale-[1.02] border-t-4 border-yellow-500">
        <div class="p-5 flex items-center justify-between">
            <div>
                ...
                <div class="mt-1 text-3xl font-semibold text-gray-900"><?php echo e(number_format($newOrdersCount)); ?></div>
            </div>
        ...
        <div class="px-5 py-3 bg-gray-50 text-sm">
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-yellow-600 hover:text-yellow-900 font-medium">Lihat Pesanan Pending &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-lg rounded-xl transition duration-300 hover:shadow-2xl hover:scale-[1.02] border-t-4 border-green-500">
        <div class="p-5 flex items-center justify-between">
            <div>
                ...
                <div class="mt-1 text-3xl font-semibold text-gray-900">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></div>
            </div>
        ...
        <div class="px-5 py-3 bg-gray-50 text-sm">
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-green-600 hover:text-green-900 font-medium">Laporan Penjualan &rarr;</a>
        </div>
    </div>
    ...
    <div class="bg-white overflow-hidden shadow-lg rounded-xl transition duration-300 hover:shadow-2xl hover:scale-[1.02] border-t-4 border-purple-500">
        <div class="p-5 flex items-center justify-between">
            <div>
                ...
                <div class="mt-1 text-3xl font-semibold text-gray-900"><?php echo e(number_format($totalUsers)); ?></div>
            </div>
...
<div class="mt-8 grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 bg-white shadow-lg rounded-xl p-6">
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-900">#<?php echo e($order->id); ?></td>
                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-500"><?php echo e($order->user->name ?? 'Pengguna Tidak Ditemukan'); ?></td>
                        <td class="px-3 py-4 whitespace-nowrap text-sm text-gray-900">Rp <?php echo e(number_format($order->total, 0, ',', '.')); ?></td>
                        ...
                        <td class="px-3 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="<?php echo e(route('admin.orders.show', $order->id)); ?>" class="text-indigo-600 hover:text-indigo-900">Detail</a>
                        </td>
                    </tr>
        ...
        <div class="mt-4 text-right">
            <a href="<?php echo e(route('admin.orders.index')); ?>" class="text-indigo-600 hover:text-indigo-900 font-semibold text-sm">Lihat Semua Pesanan &rarr;</a>
        </div>
    </div>
    ...
    <div class="lg:col-span-1 space-y-6">
        ...
        <div class="bg-white shadow-lg rounded-xl p-6">
            ...
            <div class="space-y-3">
                <a href="<?php echo e(route('admin.products.create')); ?>" class="flex items-center p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition duration-150">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>" class="flex items-center p-3 rounded-lg bg-gray-50 hover:bg-gray-100 transition duration-150">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alfin\lelang_app\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>