            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="border-b hover:bg-blue-50/50 transition">
                        ...
                        <td class="py-3 px-4 font-medium"><?php echo e($category->name); ?></td>
                        <td class="py-3 px-4 text-gray-600"><?php echo e($category->slug); ?></td>
                        <td class="py-3 px-4 text-gray-500"><?php echo e($category->created_at->format('d M Y')); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alfin\lelang_app\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>