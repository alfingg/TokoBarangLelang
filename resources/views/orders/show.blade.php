    ...
    <div class="space-y-8">
        ...
        <div class="bg-gradient-to-r from-blue-50 via-white to-blue-50 shadow-lg rounded-2xl p-6 border border-blue-100">
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4 gap-2">
                ...
                <span class="px-4 py-2 rounded-full border text-sm font-semibold {{ $statusClass }}">
            ...
            <div class="border-t border-gray-200 mt-4 pt-4 text-gray-700">
                ...
                <p class="text-lg font-bold">
                    Total Pembayaran: 
                    <span class="text-blue-700">Rp {{ number_format($order->total, 0, ',', '.') }}</span>
                </p>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md rounded-2xl p-6 border border-gray-100">
            ...
            <p class="text-gray-700 mb-1"><strong>Penerima:</strong> {{ $order->user->name ?? 'Tamu' }}</p>
            <p class="text-gray-600">
                {{ $order->shipping_address ?? 'Alamat pengiriman belum diisi.' }}
            </p>
        </div>
        ...
        <div class="bg-white shadow-lg rounded-2xl p-6 border border-gray-100">
            ...
            <div class="mt-6 pt-4 border-t border-gray-200 text-right">
                <p class="text-lg font-semibold text-gray-800">
                    Total Pesanan: <span class="text-blue-700 font-bold">Rp {{ number_format($order->total, 0, ',', '.') }}</span>
                </p>
            </div>
        </div>
    </div>
